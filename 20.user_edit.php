<?php
    ...
    {   
        ...
        if (!mysqli_query($conn, "update user set pwd='{$_POST['pwd']}' where id='{$_POST['id']}'")) //使用接收到的id欄位尋找在變數conn中的id欄位 並將那個欄位的pwd更新成接收到的pwd
        {
        ...
        {
            echo "修改成功，三秒鐘後回到網頁"; //輸出 修改成功，三秒鐘後回到網頁
