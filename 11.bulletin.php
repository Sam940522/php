<?php
    ...
    session_start();    //使用session保存使用者資料
    if (!$_SESSION["id"]) //檢查資料id是否為空 是的話執行下行
    {
    
        echo "請先登入"; //輸出 請先登入
        echo "<meta http-equiv=REFRESH content='3, url=2.login.html'>"; //上行代碼執行完經過3秒後,自動跳轉到2.login.html
    }
    else
    {
        echo "歡迎, ".$_SESSION["id"]. //輸出 歡迎 資料id
